...
public class Wheel extends JPanel {
    ...
    public Wheel(ArrayList<String> listOfStrings) {
         ...
         */
        allNames = new ArrayList<>(listOfStrings);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                double initialSpeed = 4000+Math.random()*4000;
    ...
    private class SpinRunnable implements Runnable {
        ...
        public void run() {
            ...
            _stringList.remove(selection);
            setListOfStrings(_stringList);
            JOptionPane.showMessageDialog(getParent(), "Selection: " + selection);
            if(_stringList.isEmpty()){
                JOptionPane.showMessageDialog(getParent(),"No names left");
                setListOfStrings(new ArrayList<>(allNames));
            }
        }
    }
